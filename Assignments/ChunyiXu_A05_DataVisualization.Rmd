...
> Answer:The plot in Q7 is more effective. Since we want to observe how the dry mass changes over time, a line graph will be more appropriate for plotting. In Q6, the lines for three NLCD classes overlap with each other, making it challenging to distiguish one from the other and observe any trends. The whole graph in Q6 becomes messy. However, by separating the line graphs of the three NLCD classes into three facets, each graph is clearer and easier to read trends. 