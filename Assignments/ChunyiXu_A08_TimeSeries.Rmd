...
GaringerOzone.daily.ts <- ts(GaringerOzone_Fill$Daily.Max.8.hour.Ozone.Concentration_Fill, start = c(2010,1,1), frequency = 365)

#Generating the time series object based on the dataframe of monthly observations
GaringerOzone.monthly.ts <- ts(GaringerOzone.monthly$Monthly_Mean_Ozone, start = c(2010,1), frequency = 12)
